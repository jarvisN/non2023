...
# Initialize a variable to store the cumulative sum of numbers
cumulative_sum = 0
...
while cap.isOpened():
    ...
    cv2.putText(frame, f"Cumulative Sum: {cumulative_sum}", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
    # Display the frame
...
print(f"The cumulative sum of the numbers detected is: {cumulative_sum}")
