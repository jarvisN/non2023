...
import 'data/esp/setting_info.dart';
import 'data/esp/getLux.dart';
import 'data/esp/getWeight.dart';
import 'data/esp/config_firmware.dart';

import 'data/camera/getReady.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> fetchData() async {
    ...
    } else if (dropdownValue == 'get ready cam') {
      data = ReadyCam.fetchData();
    }
